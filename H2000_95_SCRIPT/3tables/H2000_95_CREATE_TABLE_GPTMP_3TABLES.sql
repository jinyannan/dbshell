...
drop table IF EXISTS STF_CORP_RECORD_GPTMP;

create table STF_CORP_RECORD_GPTMP
(
  CMD_TYPE  VARCHAR(1),
  ENTRY_ID       VARCHAR(18)  ,
...
\echo --------------TB_PCS------------
drop table IF EXISTS TB_PCS_GPTMP;

create table TB_PCS_GPTMP
(
  CMD_TYPE  VARCHAR(1),
  SEQ_NO        NUMERIC(9),
  PCS_NO_S      VARCHAR(13)  ,
...
\echo --------------TB_PCS_HIS------------
drop table IF EXISTS TB_PCS_HIS_GPTMP;

create table TB_PCS_HIS_GPTMP
(
  CMD_TYPE  VARCHAR(1),
  SEQ_NO        NUMERIC(9),
  PCS_NO_S      VARCHAR(13)  ,
