...
delete from BWS_FORM_LIST using BWS_FORM_LIST_GPTMP where BWS_FORM_LIST_GPTMP.FORM_ID=BWS_FORM_LIST.FORM_ID AND BWS_FORM_LIST_GPTMP.G_NO=BWS_FORM_LIST.G_NO ;
